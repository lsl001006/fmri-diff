...
## research project for zbh lsl
### 4.14
+ text clip loss for LDM
    + code/dc_ldm/models/diffusion/ddpm_clip.py
    + code/dc_ldm/ldm_for_fmri_clip.py
+ unidiffuser controlnet
    + code/uni_md/diffusion/uvit_fmri_control.py，模型结构，多层condition的大结构参考code/uni_md/diffusion/uvit_fmri_zbh.py，如何添加bloc模块，参考code/uni_md/diffusion/uvit_fmri_text.py的fmri2text_nnet
    + code/uni_md/unid_fmri_control.py，训练与可视化，参考code/uni_md/unid_fmri_pred_text.py的uniDM
    + code/stageB_uni_finetune.py，调用unid_fmri_control.py
