...
from uni_md.unid_fmri_pred_text import uniDM
...
def main(config):
    ...
    train_DM.finetune(autoencoder, caption_decoder, clip_img_model, fmri_latents_dataset_train, fmri_latents_dataset_test, config.batch_size)
