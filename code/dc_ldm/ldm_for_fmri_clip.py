...
class cond_stage_model(nn.Module):
    def __init__(self, metafile, num_voxels, cond_dim=1280, clip_dim=512, global_pool=True):
        super().__init__()
...
class fLDM:
    ...
    def __init__(self, metafile, num_voxels, device=torch.device('cpu'),
        ...
        self.config_path = os.path.join('/data/zbh/code/nips2023/fmri-diffusion/fmri-diffusion/pretrains/ldm/label2img/', 'config.yaml') 
